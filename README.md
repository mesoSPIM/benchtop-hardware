![Benchtop V2](https://github.com/mesoSPIM/benchtop-hardware/blob/main/Benchtop/CAD-model-Inventor2021/mesoSPIM/renderings/overview/benchtop-mesoSPIM_latest.png)
...
| 					| **Optical Table mesoSPIM (v5)** | **Benchtop mesoSPIM** |
|----------|----------|--------------------|
